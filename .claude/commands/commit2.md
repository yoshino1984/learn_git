---
name: commit2
description: Generate conventional commit messages following the Conventional Commits specification. Use when user wants to create a standardized git commit, asks for help with commit message format, or runs /commit2 command.
user-invocable: true
